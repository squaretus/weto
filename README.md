...
- **Linux**: Ubuntu 24.04 LTS и новее, Arch; x86_64. Нужен GTK не ниже 4.14.
...
верхнего релиза файл `weto-версия-x86_64-linux.tar.zst`.

### Шаг 2. Распаковать и установить

```bash
tar --zstd -xf weto-*-x86_64-linux.tar.zst
cd weto-*/
./install.sh
```
