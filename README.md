...
этим занимается служебный компонент, который установщик кладёт в систему вместе
с приложением. По ходу установки weto закроется и запустится заново уже обновлённым.

Внизу окна настроек та же кнопка: круглая стрелка проверяет обновления, а когда они
найдены — стрелка вниз устанавливает. Если служебный компонент почему-то недоступен,
