...
3. закрытие последнего окна крестиком — трей при этом может быть, а может
   и не быть: без окон приложение завершается само, и этот путь мимо кнопок
   раньше оставлял цели стоять;
