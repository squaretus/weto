...
public enum Constants {
    ...
    /// Третий источник собственного адреса — когда молчат и ipinfo, и geojs. Только адрес,
    /// без страны: его хватает, чтобы доказать «адрес тот же — страна та же».
    /// Хост обязан идти в туннель: клиенты исключают отдельные адреса из VPN,
    /// и владелец проверяет это руками при смене хоста.
    public static let selfIPFallbackURL = "https://checkip.amazonaws.com"
