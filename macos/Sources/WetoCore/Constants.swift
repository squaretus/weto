...
public enum Constants {
    ...
    /// Сколько подряд неудачных проб при неизменном отпечатке и установленном
    /// вердикте терпит охрана, не меняя состояния: молчание сервисов — не то же
    /// самое, что смена сети.
    public static let silenceToleranceProbes = 2
