...
public final class AppCoordinator {
    ...
    /// ещё показывает стоящими. Нужно ровно удалению: всюду ещё запись, которую
    /// выход не разрешил, достаётся следующему запуску, а после удаления его
    /// не будет — учёт исчезает вместе с приложением.
    public func confirmResumed() -> [StoppedProcess] {
        guardVM.confirmResumed()
    }
}
