...
- `NSWorkspace.didLaunchApplicationNotification` и `didTerminateApplicationNotification`
  ...
  а под красным статусом — раз в 250 мс (полный обход 230 процессов — 5 мс). Живого
  системного события про запуск нового терминального процесса без Endpoint Security
